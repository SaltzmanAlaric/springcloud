...
public class MyBatisPlusGenerator {
    ...
    private static class Path {
        private static final String PROJECT_PATH = System.getProperty("user.dir")+"/provider/";
    ...
    private static final String AUTHOR = "saltzman";
    private static final String URL_PREFIX = "";
    private static final boolean SELECTALL = true;
    private static final boolean FINDPAGE = true;
    // 是否生成query.java
    private static final boolean QUERY = true;//SELECTALL || FINDPAGE;
...
//              .setEntity(null)
        ...
        if (QUERY) {
            fileOutList.add(new FileOutConfig("/templates/query.java.ftl") {
                ...
                public String outputFile(TableInfo tableInfo) {
                    tableInfo.setImportPackages("com.study.common.aspect.Sort");
        ...
        mpg.setStrategy(new StrategyConfig()
                ...
                .setSuperServiceImplClass("com.study.common.service.BaseService")
                // 自定义 controller 父类
